...
use common::{
    Config, RecordingHook, SharedRecordingHook, admitted, assigned, at, bare_stream, boxed,
    gauge_point, heavy_stream,
};
use runtime_trail_storage::KeepOutcome;
use runtime_trail_telemetry_model::Accounted;

fn config(max_records: u64, max_accounted_bytes: u64, series_cap: u64) -> Config {
    Config {
        max_records,
        max_accounted_bytes,
        series_cap,
