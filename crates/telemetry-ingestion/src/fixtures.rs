...
impl Harness {
    ...
    #[must_use]
    pub fn with_queue_ceiling(ceiling: usize) -> Self {
    ...
    // This crate's own tests also call `drain` for its queue-emptying side
    // effect alone, so the result cannot be `#[must_use]` — the scoped
    // exception to the pedantic lint is that dual use, nothing else.
...
#[must_use]
pub fn str_value(text: &str) -> common::AnyValue {
    common::AnyValue {
...
#[must_use]
pub fn int_value(value: i64) -> common::AnyValue {
    common::AnyValue {
...
#[must_use]
pub fn double_value(value: f64) -> common::AnyValue {
    common::AnyValue {
...
#[must_use]
pub fn bytes_value(bytes: Vec<u8>) -> common::AnyValue {
    common::AnyValue {
...
#[must_use]
pub fn array_value(items: Vec<common::AnyValue>) -> common::AnyValue {
    common::AnyValue {
...
#[must_use]
pub fn kvlist_value(entries: Vec<common::KeyValue>) -> common::AnyValue {
    common::AnyValue {
...
#[must_use]
pub fn empty_value() -> common::AnyValue {
    common::AnyValue { value: None }
}

#[must_use]
pub fn attr(key: &str, value: common::AnyValue) -> common::KeyValue {
    common::KeyValue {
        key: key.to_owned(),
        value: Some(value),
        key_strindex: 0,
...
#[must_use]
pub fn resource(attributes: Vec<common::KeyValue>) -> resource::Resource {
    resource::Resource {
        attributes,
...
#[must_use]
pub fn scope(name: &str) -> common::InstrumentationScope {
...
#[must_use]
pub fn trace_span(name: &str, trace_id: [u8; 16], span_id: [u8; 8]) -> trace::Span {
    trace::Span {
...
#[must_use]
pub fn scope_spans_with_schema_url(
    schema_url: &str,
    scope: Option<common::InstrumentationScope>,
    spans: Vec<trace::Span>,
) -> trace::ScopeSpans {
...
#[must_use]
pub fn resource_spans_with_schema_url(
    schema_url: &str,
    resource: Option<resource::Resource>,
    scope_spans: Vec<trace::ScopeSpans>,
) -> trace::ResourceSpans {
...
#[must_use]
pub fn log_record() -> logs::LogRecord {
    logs::LogRecord {
        time_unix_nano: 0,
...
#[must_use]
pub fn metric(name: &str, data: metrics::metric::Data) -> metrics::Metric {
    metrics::Metric {
        name: name.to_owned(),
...
#[must_use]
pub fn number_point(value: metrics::number_data_point::Value) -> metrics::NumberDataPoint {
...
#[must_use]
pub fn gauge(points: Vec<metrics::NumberDataPoint>) -> metrics::metric::Data {
...
#[must_use]
pub fn as_double(value: f64) -> metrics::number_data_point::Value {
    metrics::number_data_point::Value::AsDouble(value)
}

/// An integer measurement.
#[must_use]
pub fn as_int(value: i64) -> metrics::number_data_point::Value {
    metrics::number_data_point::Value::AsInt(value)
}

#[must_use]
pub fn scope_metrics(
    scope: Option<common::InstrumentationScope>,
...
#[must_use]
pub fn scope_metrics_with_schema_url(
    schema_url: &str,
    scope: Option<common::InstrumentationScope>,
    metrics_list: Vec<metrics::Metric>,
) -> metrics::ScopeMetrics {
...
#[must_use]
pub fn resource_metrics_with_schema_url(
    schema_url: &str,
    resource: Option<resource::Resource>,
    scope_metrics: Vec<metrics::ScopeMetrics>,
) -> metrics::ResourceMetrics {
...
pub const T1: [u8; 16] = [0x01; 16];
/// A second valid trace id.
pub const T2: [u8; 16] = [0x02; 16];
/// A valid span id that is not zero.
pub const S1: [u8; 8] = [0x11; 8];
/// A second valid span id.
pub const S2: [u8; 8] = [0x22; 8];
...
/// # Panics
///
/// Panics when the record at `position` was not refused — a miswritten
/// assertion, not a runtime condition.
#[must_use]
pub fn rejected_reason(outcome: &ExportOutcome, position: usize) -> &RecordRejection {
...
/// # Panics
///
/// Panics when the record at `position` was refused — a miswritten
/// assertion, not a runtime condition.
#[must_use]
pub fn standing_entity(outcome: &ExportOutcome, position: usize) -> EntityId {
    match &outcome.records[position] {
...
/// # Panics
///
/// Panics if `value` does not fit a `usize` after masking — impossible for
/// the wire fixtures, which build sub-message lengths.
pub fn varint(mut value: usize, out: &mut Vec<u8>) {
    loop {
...
#[must_use]
pub fn field(tag: u8, payload: &[u8]) -> Vec<u8> {
    let mut out = vec![tag];
